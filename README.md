...
| seoFriendly           | Optional. Boolean. The default value is `false`. If set to `true`, the SDK generates an URL with `/ik-seo` allowing defining a seo-friendly name of the image.                                                                                                                                                                                                                                                                                                                                                                                                                           |  

...
use ImageKit\AITaskAction\SetMetadata;
use ImageKit\AITaskAction\UnsetMetadata;
 ...
 *
 * @phpstan-import-type SetMetadataShape from \ImageKit\AITaskAction\SetMetadata
 * @phpstan-import-type UnsetMetadataShape from \ImageKit\AITaskAction\UnsetMetadata
 *
 * @phpstan-type AITaskActionShape = array{
 ...
 * }
 */
final class AITaskAction implements BaseModel
{
    /** @use SdkModel<AITaskActionShape> */
    use SdkModel;

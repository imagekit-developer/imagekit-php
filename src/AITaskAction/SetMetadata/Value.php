...
namespace ImageKit\AITaskAction\SetMetadata;

use ImageKit\AITaskAction\SetMetadata\Value\Mixed_;
 ...
 *
 * @phpstan-import-type MixedShape from \ImageKit\AITaskAction\SetMetadata\Value\Mixed_
 *

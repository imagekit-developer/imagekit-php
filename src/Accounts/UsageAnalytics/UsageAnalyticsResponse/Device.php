...
use ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\Device\ByBandwidth;
use ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\Device\ByRequest;
 ...
 *
 * @phpstan-import-type ByBandwidthShape from \ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\Device\ByBandwidth
 * @phpstan-import-type ByRequestShape from \ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\Device\ByRequest
 *
...
final class Device implements BaseModel
{
     ...
     * ```
     * Device::with(byBandwidth: ..., byRequests: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Device)->withByBandwidth(...)->withByRequests(...)
     * ```
     */

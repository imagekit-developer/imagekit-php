...
namespace ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\Device;
...
final class ByRequest implements BaseModel
{
    ...
    /**
     * Device category combined with operating system or vendor (e.g. `Desktop - Windows PC`).
     */
    #[Required]
    public string $name;

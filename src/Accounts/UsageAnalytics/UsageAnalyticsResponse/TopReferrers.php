...
use ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\TopReferrers\ByBandwidth;
use ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\TopReferrers\ByRequest;
 ...
 *
 * @phpstan-import-type ByBandwidthShape from \ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\TopReferrers\ByBandwidth
 * @phpstan-import-type ByRequestShape from \ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\TopReferrers\ByRequest
 *
 * @phpstan-type TopReferrersShape = array{
 *   byBandwidth: list<ByBandwidth|ByBandwidthShape>,
 *   byRequests: list<ByRequest|ByRequestShape>,
 * }
 */
final class TopReferrers implements BaseModel
{
    /** @use SdkModel<TopReferrersShape> */
    use SdkModel;
    ...
    /**
     * `new TopReferrers()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TopReferrers::with(byBandwidth: ..., byRequests: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TopReferrers)->withByBandwidth(...)->withByRequests(...)
     * ```
     */

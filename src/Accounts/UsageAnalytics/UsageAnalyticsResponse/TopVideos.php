...
use ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\TopVideos\ByBandwidth;
use ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\TopVideos\ByRequest;
 ...
 *
 * @phpstan-import-type ByBandwidthShape from \ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\TopVideos\ByBandwidth
 * @phpstan-import-type ByRequestShape from \ImageKit\Accounts\UsageAnalytics\UsageAnalyticsResponse\TopVideos\ByRequest
 *
 * @phpstan-type TopVideosShape = array{
 *   byBandwidth: list<ByBandwidth|ByBandwidthShape>,
 *   byRequests: list<ByRequest|ByRequestShape>,
 * }
 */
final class TopVideos implements BaseModel
{
    /** @use SdkModel<TopVideosShape> */
    use SdkModel;
    ...
    /**
     * `new TopVideos()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TopVideos::with(byBandwidth: ..., byRequests: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TopVideos)->withByBandwidth(...)->withByRequests(...)
     * ```
     */

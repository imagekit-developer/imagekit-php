...
use ImageKit\Assets\FileVersionDetails\Type;
 ...
 *
 * @phpstan-type FileVersionDetailsShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class FileVersionDetails implements BaseModel
{
    /** @use SdkModel<FileVersionDetailsShape> */
    use SdkModel;

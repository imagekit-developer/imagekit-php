...
use ImageKit\Assets\UploadRequest\Overwrite;
use ImageKit\Assets\UploadRequest\Transformation;
 ...
 * @phpstan-import-type OverwriteShape from \ImageKit\Assets\UploadRequest\Overwrite
 * @phpstan-import-type TransformationShape from \ImageKit\Assets\UploadRequest\Transformation
 *
 * @phpstan-type UploadRequestShape = array{
 ...
 * }
 */
final class UploadRequest implements BaseModel
{
    /** @use SdkModel<UploadRequestShape> */
    use SdkModel;
    ...
    /**
     * `new UploadRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * UploadRequest::with(file: ..., fileName: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new UploadRequest)->withFile(...)->withFileName(...)
     * ```
     */

...
use ImageKit\Assets\UploadResponse\ExtensionStatus;
use ImageKit\Assets\UploadResponse\SelectedFieldsSchema;
 ...
 * @phpstan-import-type ExtensionStatusShape from \ImageKit\Assets\UploadResponse\ExtensionStatus
 * @phpstan-import-type SelectedFieldsSchemaShape from \ImageKit\Assets\UploadResponse\SelectedFieldsSchema
 *
 * @phpstan-type UploadResponseShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class UploadResponse implements BaseModel
{
    /** @use SdkModel<UploadResponseShape> */
    use SdkModel;
     ...
     */
    #[Optional('selected_fields_schema', map: SelectedFieldsSchema::class)]

...
namespace ImageKit\ExtensionConfig\AITasksExtension\Task\AITaskYesNo\OnNo;

use ImageKit\Core\Attributes\Required;
use ImageKit\Core\Concerns\SdkModel;
use ImageKit\Core\Contracts\BaseModel;
use ImageKit\ExtensionConfig\AITasksExtension\Task\AITaskYesNo\OnNo\SetMetadata\Value;

/**
 * @phpstan-import-type ValueVariants from \ImageKit\ExtensionConfig\AITasksExtension\Task\AITaskYesNo\OnNo\SetMetadata\Value
 * @phpstan-import-type ValueShape from \ImageKit\ExtensionConfig\AITasksExtension\Task\AITaskYesNo\OnNo\SetMetadata\Value
 *

...
use Imagekit\ExtensionConfig\AITasksExtension\Task\AITaskYesNo\OnYes\SetMetadata;
use Imagekit\ExtensionConfig\AITasksExtension\Task\AITaskYesNo\OnYes\UnsetMetadata;

/**
 * Actions to execute if the AI answers yes.
 *
 * @phpstan-import-type SetMetadataShape from \Imagekit\ExtensionConfig\AITasksExtension\Task\AITaskYesNo\OnYes\SetMetadata
 * @phpstan-import-type UnsetMetadataShape from \Imagekit\ExtensionConfig\AITasksExtension\Task\AITaskYesNo\OnYes\UnsetMetadata
 *
 * @phpstan-type OnYesShape = array{
 ...
 * }
 */
final class OnYes implements BaseModel
{
    /** @use SdkModel<OnYesShape> */
    use SdkModel;

...
namespace Imagekit\ExtensionItem\AITasksExtension\Task\AITaskYesNo\OnNo\SetMetadata;

use Imagekit\Core\Concerns\SdkUnion;
use Imagekit\Core\Conversion\Contracts\Converter;
use Imagekit\Core\Conversion\Contracts\ConverterSource;
use Imagekit\Core\Conversion\ListOf;
use Imagekit\ExtensionItem\AITasksExtension\Task\AITaskYesNo\OnNo\SetMetadata\Value\Mixed_;

/**
 * Value to set for the custom metadata field. The value type should match the custom metadata field type.
 *
 * @phpstan-import-type MixedShape from \Imagekit\ExtensionItem\AITasksExtension\Task\AITaskYesNo\OnNo\SetMetadata\Value\Mixed_
 *

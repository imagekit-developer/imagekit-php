...
use ImageKit\Files\Details\DetailUpdateParams\Extension;
...
use ImageKit\Files\Details\DetailUpdateParams\RemoveAITags;
 ...
 *   extensions?: list<RemovedotBgExtension|AutoTaggingExtension>,
 ...
 * }
 */
final class DetailUpdateParams implements BaseModel
{
    use Model;
    use Params;
     ...
     *
     * @var null|list<AutoTaggingExtension|RemovedotBgExtension> $extensions
     */
     ...
     *
     * @param null|list<AutoTaggingExtension|RemovedotBgExtension> $extensions

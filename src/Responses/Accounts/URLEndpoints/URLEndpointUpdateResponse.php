...
use ImageKit\Responses\Accounts\URLEndpoints\URLEndpointUpdateResponse\URLRewriter;
 ...
 *
 * @phpstan-type url_endpoint_update_response_alias = array{
 *   id: string,
 *   description: string,
 *   origins: list<string>,
 *   urlPrefix: string,
 ...
 * }
 */
final class URLEndpointUpdateResponse implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new URLEndpointUpdateResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * URLEndpointUpdateResponse::with(

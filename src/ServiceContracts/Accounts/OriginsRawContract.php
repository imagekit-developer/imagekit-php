...
interface OriginsRawContract
{
     ...
     *
     * @return BaseResponse<S3|S3Compatible|CloudinaryBackup|WebFolder|WebProxy|Gcs|AzureBlob|AkeneoPim,>
     *
     * @throws APIException
     */
     ...
     * @api
     *
     * @return BaseResponse<list<S3|S3Compatible|CloudinaryBackup|WebFolder|WebProxy|Gcs|AzureBlob|AkeneoPim>,>
     *
     * @throws APIException
     */

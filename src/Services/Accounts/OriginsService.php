...
final class OriginsService implements OriginsContract
{
     ...
     *
     * @param string $accessKey Access key for the bucket. When `useIAMRole` is `true`, send an empty string.
     * @param string $name display name of the origin
     * @param string $secretKey Secret key for the bucket. When `useIAMRole` is `true`, send an empty string.
     ...
     * @param bool $useIamRole Use IAM role for authentication instead of access/secret keys. When set to `true`, send an empty string for both `accessKey` and `secretKey`.
